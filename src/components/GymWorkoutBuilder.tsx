...
// Separate component for manual builder to avoid code duplication
interface ManualBuilderProps {
  ...
  updateExercise: (id: string, field: keyof WorkoutExercise, value: string | number) => void;
  catalogExercises: CatalogExercise[];
  muscleGroups: { id: string; name: string; category: string }[];
  loading: boolean;
  saving: boolean;
  saveWorkout: () => Promise<void>;
  showAIAssistant: boolean | null;
  setShowAIAssistant: (show: boolean | null) => void;
}
