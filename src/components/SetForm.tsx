  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="h-11 text-center text-lg font-bold bg-background border-2 focus:border-primary"
          />
        </div>
        <div className="space-y-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="h-11 text-center font-semibold bg-background border-2 focus:border-primary"
          />
        </div>
        <div className="space-y-1.5">
      ...
      <AnimatePresence>
        {success && (
          <motion.div 
            ...
            className="p-3 bg-green-500/10 border border-green-500/20 rounded-xl flex items-center justify-center gap-2"
          >
      ...
      <Button
        ...
        size="lg"
        disabled={loading}
        className="w-full gradient-primary text-primary-foreground font-semibold h-12 text-base rounded-xl"
      >
        {loading ? (
