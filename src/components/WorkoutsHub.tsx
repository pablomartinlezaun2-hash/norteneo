    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        >
          ...
          <span className="text-sm font-medium text-primary">Centro de Entrenamientos</span>
        </motion.div>
        <h2 className="text-2xl font-bold text-foreground">Entrenamientos</h2>
        <p className="text-sm text-muted-foreground mt-1">
          Accede a todas tus rutinas desde un solo lugar
        </p>
      </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={cn(
                    ...
                    <Icon className={cn(
                      "w-5 h-5",
                      isExpanded ? "text-white" : section.textColor
                    )} />
                  </div>
