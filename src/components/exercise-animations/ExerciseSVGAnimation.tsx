...
const StickFigure = ({ pose, primaryColor, secondaryColor }: { pose: Pose; primaryColor: string; secondaryColor: string }) => {
  ...
  return (
    <g>
      <line x1={neckX} y1={neckY} x2={hipX} y2={hipY} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <circle cx={headX} cy={headY} r={HEAD_R} fill={secondaryColor} stroke={primaryColor} strokeWidth={1.5} />
      <line x1={lShoulderX} y1={neckY} x2={lElbow.x} y2={lElbow.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={lElbow.x} y1={lElbow.y} x2={lHand.x} y2={lHand.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={rShoulderX} y1={neckY} x2={rElbow.x} y2={rElbow.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={rElbow.x} y1={rElbow.y} x2={rHand.x} y2={rHand.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={lHipX} y1={hipY} x2={lKnee.x} y2={lKnee.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={lKnee.x} y1={lKnee.y} x2={lFoot.x} y2={lFoot.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={rHipX} y1={hipY} x2={rKnee.x} y2={rKnee.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      <line x1={rKnee.x} y1={rKnee.y} x2={rFoot.x} y2={rFoot.y} stroke={primaryColor} strokeWidth={sw} strokeLinecap="round" />
      {pose.hasBarbell && <line x1={lHand.x - 6} y1={lHand.y} x2={rHand.x + 6} y2={rHand.y} stroke={secondaryColor} strokeWidth={3} strokeLinecap="round" opacity={0.8} />}
      {pose.hasDumbbell && (
        <>
...
export const ExerciseSVGAnimation = ({ exerciseName, className = '', compact = false }: ExerciseSVGAnimationProps) => {
  ...
  return (
    <div ref={containerRef} className={`relative overflow-hidden rounded-lg bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 ${compact ? 'w-16 h-16' : 'aspect-video'} ${className}`}>
      <svg viewBox="0 0 100 75" className="w-full h-full" style={{ filter: 'drop-shadow(0 1px 2px rgba(0,0,0,0.1))' }}>
