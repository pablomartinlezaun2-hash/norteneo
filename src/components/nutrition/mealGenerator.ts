...
const FOOD_DATABASE: FoodData[] = [
  // Proteins
  { name: 'Pechuga de pollo', caloriesPer100g: 165, proteinPer100g: 31, carbsPer100g: 0, fatPer100g: 3.6, unit: 'g', servingSize: 150, category: 'protein' },
  ...
  // Carbs
  { name: 'Arroz blanco', caloriesPer100g: 130, proteinPer100g: 2.7, carbsPer100g: 28, fatPer100g: 0.3, unit: 'g', servingSize: 80, category: 'carb' },
  { name: 'Arroz integral', caloriesPer100g: 111, proteinPer100g: 2.6, carbsPer100g: 23, fatPer100g: 0.9, unit: 'g', servingSize: 80, category: 'carb' },
  ...
  { name: 'Pasta integral', caloriesPer100g: 124, proteinPer100g: 5, carbsPer100g: 25, fatPer100g: 0.5, unit: 'g', servingSize: 80, category: 'carb', allergens: ['gluten'] },
  ...
  { name: 'Avena', caloriesPer100g: 389, proteinPer100g: 17, carbsPer100g: 66, fatPer100g: 7, unit: 'g', servingSize: 50, category: 'carb', allergens: ['gluten'] },
  ...
  // Fats
  { name: 'Aceite de oliva', caloriesPer100g: 884, proteinPer100g: 0, carbsPer100g: 0, fatPer100g: 100, unit: 'ml', servingSize: 15, category: 'fat' },
  ...
  { name: 'Nueces', caloriesPer100g: 654, proteinPer100g: 15, carbsPer100g: 14, fatPer100g: 65, unit: 'g', servingSize: 30, category: 'fat', allergens: ['frutos secos'] },
  ...
  { name: 'Leche desnatada', caloriesPer100g: 34, proteinPer100g: 3.4, carbsPer100g: 5, fatPer100g: 0.1, unit: 'ml', servingSize: 250, category: 'dairy', allergens: ['lactosa'] },
  ...
  { name: 'Manzana', caloriesPer100g: 52, proteinPer100g: 0.3, carbsPer100g: 14, fatPer100g: 0.2, unit: 'g', servingSize: 180, category: 'fruit' },
  { name: 'Fresas', caloriesPer100g: 33, proteinPer100g: 0.7, carbsPer100g: 8, fatPer100g: 0.3, unit: 'g', servingSize: 150, category: 'fruit' },
  { name: 'Arándanos', caloriesPer100g: 57, proteinPer100g: 0.7, carbsPer100g: 14, fatPer100g: 0.3, unit: 'g', servingSize: 100, category: 'fruit' },
];
...
const getMealDistribution = (numMeals: number, isTrainingDay: boolean): { name: string; template: typeof MEAL_TEMPLATES.desayuno }[] => {
  const distributions: Record<number, { name: string; template: typeof MEAL_TEMPLATES.desayuno }[]> = {
    ...
    4: [
      ...
      { name: 'Merienda', template: MEAL_TEMPLATES.merienda },
    ...
    6: [
      ...
      { name: 'Merienda', template: MEAL_TEMPLATES.merienda },
      { name: 'Cena', template: MEAL_TEMPLATES.cena },
      { name: isTrainingDay ? 'Post-Entreno' : 'Recena', template: MEAL_TEMPLATES.postEntreno },
    ],
  };
  
  return distributions[numMeals] || distributions[4];
};
